...
const insertMemberFromAdmin = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "Member is registered successfully!" });
  } catch (error) {
    console.log(
      "This is the error of authControllerForMember.js > insertMemberFromMainWebsite > newUserData",
      error
    );
    return res.status(500).json({ message: "Member registration has failed!" });
  }
};
...
const insertMemberFromMainWebsite = async (req, res) => {
  try {
    ...
    // console.log("filenameLocalPath: ", filenameLocalPath);
...
const loadProfileForAdmin = async (req, res) => {
  try {
    ...
    // console.log(userData1.filename);
...
const loadProfile = async (req, res) => {
  try {
    ...
    const dataTableOfAdvertisement = await Advertisement.find();
    // const college_list = await CollegeList.find();
...
const conselling_of_user_status = async (req, res) => {
  try {
    ...
    // console.log("trimmed_id_of_user: ", trimmed_id_of_user);
    // console.log("trimmed_status: ", trimmed_status);
...
const college_preference = async (req, res) => {
  try {
    ...
    // console.log("trimmed_id_of_user: ", trimmed_id_of_user);
    // console.log("trimmed_preference: ", trimmed_preference);
...
const college_verification_process = async (req, res) => {
  try {
    ...
    // console.log("trimmed_id_of_user: ", trimmed_id_of_user);
    // console.log("trimmed_verification: ", trimmed_verification);
...
const delete_User_By_Admin = async (req, res) => {
  try {
    if (!req.body) {
      ...
      // await User.findOneAndDelete({ _id: trimmed_user_Id });
...
const delete_Author_By_Admin = async (req, res) => {
  try {
    if (!req.body) {
      ...
      // await Author.findOneAndDelete({ _id: trimmed_Author_Id });
...
const delete_Member_By_Admin = async (req, res) => {
  try {
    if (!req.body) {
      ...
      // await Member.findOneAndDelete({ _id: trimmed_Member_Id });
