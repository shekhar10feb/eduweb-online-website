...
export const MBA_State_wise_Colleges = () => {
          ...
          <li>
            <div className="flex items-center">
              ...
              <h1 className="ml-1 text-sm font-medium md:ml-2 text-gray-500">
                State/UT-wise Management Colleges
              </h1>
            </div>
          </li>
        </ol>
                ...
                {filteredDatas.length > 0 ? (
                  <ul className="w-full h-full flex justify-center items-center flex-col">
                    {filteredDatas.map((item) => {
                      if (
                        item.state_or_ut_name.toUpperCase() === uppercase_state && item.management_rank
                      ) {
                        return (
                          <div
                          ...
                          >
                            <FormatFor_State_UT_wise_Colleges
                              ...
                              state_ut_wise_colleges="mba_state_wise_colleges" 
                              text_fromm_All_Colleges="State-wise Management Colleges" 
                              field_rank={item.management_rank} 
                              field="Management" 
                              fees={item.management_fees}
                            />
                          </div>
                        );
                      }
