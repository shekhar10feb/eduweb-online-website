...
export const MEDICAL_State_wise_Colleges = () => {
          ...
          <li>
            <div className="flex items-center">
              ...
              <h1 className="ml-1 text-sm font-medium md:ml-2 text-gray-500">
                State/UT-wise Medical Colleges
              </h1>
            </div>
          </li>
        </ol>
                        ...
                        return (
                          ...
                          >
                            <FormatFor_State_UT_wise_Colleges
                              ...
                              state_ut_wise_colleges="medical_state_wise_colleges"
                              text_fromm_All_Colleges="State-wise Medical Colleges"
                              field_rank={item.medical_rank}
                              field="Medical"
                              fees={item.medical_fees}
                            />
                          </div>
                        );
                      }
