...
import { Questions } from "./FAQs implementation/Questions.jsx";
...
export const FAQs = () => {
  ...
  const fetchFAQs = async () => {
    setIsLoading(true);
    try {
      axios.get("/api/getting_FAQs").then((data) => {
        setDatas(data?.data);
      });
    } catch (error) {
      return null;
          ...
          <div className="w-full h-full flex justify-start items-start flex-col">
            ...
            <div className="w-full flex justify-center items-start flex-row">
              <div className="lg:w-[80%] w-full h-full flex justify-center items-start flex-col lg:mx-1 border-r-2 border-gray-200">
                <div className="w-full flex justify-center items-center flex-col p-2 mt-20">
                  <Questions
                    datas={datas}
                    activeId={activeId}
