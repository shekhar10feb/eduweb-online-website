...
export const MEDICAL_PAGE = () => {
  return (
    <div className="w-full h-auto flex justify-center items-center flex-col bg-white">
      <Breadcrumb
        fieldname="Medical"
        coursenameFor_big_screen="Medical: Course, Admission 2024, Fees, Syllabus, Entrance Exam, Top Colleges, Career Scope"
        coursenameFor_small_screen="Medical: Course, Admission 2024.."
        overview="Overview"
