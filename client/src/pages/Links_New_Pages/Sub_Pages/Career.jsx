...
export const Career = ({ aboutCareer, filteredDatas, fieldname }) => {
  const [careerDatas, setCareerDatas] = useState([]);
      ...
      (item) =>
        item.writtenBlogsByAuthor.filter(
          (field) =>
            ...
            field.blogSubCategory === aboutCareer
        ).length !== 0
    );
    setCareerDatas(filteredData);
  }, [filteredDatas]);
