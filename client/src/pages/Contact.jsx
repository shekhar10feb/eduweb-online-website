...
export const Contact = () => {
  ...
  function redirectToRegisterPageForAuthor() {
    window.location.href = "https://eduweb-online-website.onrender.com/api/registerForAuthor";
  }

  function redirectToLoginPageForAuthor() {
    window.location.href = "https://eduweb-online-website.onrender.com/api/loginForAuthor";
  }

  // For Member
  function redirectToRegisterPageForMember() {
    window.location.href = "https://eduweb-online-website.onrender.com/api/registerForMember";
  }

  function redirectToLoginPageForMember() {
    window.location.href = "https://eduweb-online-website.onrender.com/api/loginForMember";
  }

  // For College
  function redirectToRegisterPageForCollege() {
    window.location.href = "https://eduweb-online-website.onrender.com/api/registerForCollege";
  }

  function redirectToLoginPageForCollege() {
    window.location.href = "https://eduweb-online-website.onrender.com/api/loginForCollege";
  }
