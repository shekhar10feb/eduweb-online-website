...
export const Engineering_colleges_in_Home_Folder = () => {
      ...
      <div className="w-full bg-white md:border md:border-gray-200">
        <div className="w-full md:flex hidden justify-start items-center text-xl font-bold m-4">
          <h1 className="w-full lg:text-lg md:text-base underline text-wrap">
            College searching in Engineering field
          </h1>
        </div>
              ...
              <div className="w-full h-full flex justify-center items-center flex-col">
                {datas.length > 0 ? (
                  <ul className="w-full h-full flex justify-center items-center flex-col">
                    {datas.map((item) => {
                      if (item.engineering_rank) {
                        const link = `/All_Colleges/Engineering_colleges/${item.name}`;
                        const text_from_All_Colleges = "Engineering Colleges";
                        const goto_url = "/All_Colleges/Engineering_colleges";
                        return (
                          <div
                          ...
                          >
                            <CollegeFormat_for_List_of_Colleges_in_Engg_Management_Medical_Design_Law_Pharamacy
                              ...
                              rank={item.engineering_rank}
                              fees={item.engineering_fees}
                              course="B.E./B/Tech"
                              field="Engineering"
                            />
                          </div>
