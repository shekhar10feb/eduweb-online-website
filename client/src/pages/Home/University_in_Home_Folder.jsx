...
import { CollegeFormat_for_University_in_Home_Folder } from "./CollegeFormat_for_University_in_Home_Folder";
import { Pre_Loader } from "./Pre_Loader";
import axios from "axios";

export const University_in_Home_Folder = () => {
  ...
  useEffect(() => {
    const filteredData = datas.filter(
      (item) => item.university_name.toUpperCase() === uppercase_state
    );
                      ...
                      {filteredDatas.map((item) => {
                        ...
                        return (
                          <div className="w-full h-full flex justify-center items-start flex-col bg-white sm:p-2 p-1 my-1 shadow-lg">
                            <CollegeFormat_for_University_in_Home_Folder
                              data={item}
