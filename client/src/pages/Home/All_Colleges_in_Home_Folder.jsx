...
import { CollegeFormat_for_List_of__Colleges_in_Home_Folder } from "./CollegeFormat_for_List_of__Colleges_in_Home_Folder";
import axios from "axios";

export const All_Colleges_in_Home_Folder = () => {
                ...
                <div className="w-full h-full flex justify-center items-center flex-col">
                  {datas.length > 0 ? (
                    <ul className="w-full h-full flex justify-center items-center flex-col">
                      {datas.map((item) => {
                        const link = `/All_Colleges/${item.name}`;
                        ...
                        return (
                          <li
                            ...
                            key={item._id}
                          >
                            <CollegeFormat_for_List_of__Colleges_in_Home_Folder
                              data={item}
