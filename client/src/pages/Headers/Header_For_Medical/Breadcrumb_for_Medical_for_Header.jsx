...
export const Breadcrumb_for_Medical_for_Header = ({ fieldname }) => {
    ...
    const filteredData = datas.filter(
      (item) =>
        item.writtenBlogsByAuthor.filter(
          (field) =>
            field.blogCategory === "About Medical" &&
  ...
  return (
    <div className="w-full h-max flex justify-center items-start flex-col bg-gray-200 lg:mt-12 mt-[2.4rem] md:z-10">
      <nav
      ...
      >
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li className="inline-flex items-center">
            <Link to={"/medical"} className="inline-flex items-center">
              <svg
      ...
      <div className="w-full flex lg:hidden justify-center items-center my-1 py-2 shadow-lg">
        <Career_Conselling_And_University_Previous_Exam_Question_Papers />
      </div>

      <div className="w-full flex justify-center items-center flex-col bg-transparent md:border md:border-gray-200">
        <div className="w-full flex justify-center items-center">
          <div className="w-full flex justify-start items-start flex-col">
            ...
            <div className="w-full flex justify-center items-start flex-row p-1">
              <div className="lg:w-[80%] w-full flex justify-center items-start flex-col bg-transparent lg:mx-1">
                      ...
                      {filteredDatas.map((item) =>
                        item.writtenBlogsByAuthor.map((topic) => {
                          if (topic.blogSubCategory === fieldname) {
                            ...
                            return (
                              <div
                                className="w-full flex justify-center items-start flex-col bg-white sm:p-2 p-1 mb-1 shadow-lg"
                                key={topic._id}
                              >
